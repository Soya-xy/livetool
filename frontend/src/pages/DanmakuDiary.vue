    ...
    <div class="diary-card data-card">
      <el-tabs v-model="tab" class="diary-tabs" @tab-change="tab === 'history' && loadHistory()">
        ...
        <el-tab-pane name="history">
          ...
          <el-table :data="history" class="history-table" max-height="300">
            ...
            <el-table-column label="昵称" width="140" prop="userName" />
              <el-table-column label="内容" min-width="230"><template #default="scope">{{ recordContent(scope.row as DanmakuRecord) }}</template></el-table-column>

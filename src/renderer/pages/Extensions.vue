  ...
  <div class="page-stack extensions-page feature-page">
    <div class="feature-page-head">
      <div>
        ...
        <h1>扩展功能</h1>
        <p>每个玩法独立启用、独立设置、独立测试；设置会保存到本地配置。</p>
      </div>
    ...
    <div class="feature-grid">
      ...
      >
        ...
        <div class="feature-controls">
          <el-switch :model-value="configOf(feature.id).enabled" @update:model-value="toggleFeature(feature, $event)" />
          <el-button class="gear-button" link aria-label="打开功能设置" @click.stop="openSettings(feature)"><el-icon><Setting /></el-icon></el-button>
        </div>
      </article>
    </div>

    <div class="feature-footnote">
      <span>双击功能卡片或点击齿轮进入独立设置；礼物规则只影响当前功能。</span>
      <span>{{ assets.length }} 个可用素材 · 未连接真实平台时使用安全模拟模式</span>
    </div>
